...
public interface PrestadorRepository extends JpaRepository<Prestador, Integer>, JpaSpecificationExecutor<Prestador> {
    ...
    List<Prestador> findByEspecialidadesContaining(String especialidades);
    List<Prestador> findByStatusDisponibilidade(StatusDisponibilidadeEnum statusDisponibilidade);
